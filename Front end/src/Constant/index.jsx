...
// Default Dashboard //
export const WelcomeToCuba = 'Welcome to ISGA Tutoring Platform';
...
export const ProjectTitle = 'Course title';
...
export const Small = 'Java';
export const Medium = 'PHP';
export const Big = 'Python';

export const StartingDate = 'Starting date';
export const EndingDate = 'Ending date';
export const EnterSomeDetails = 'Description';
export const UploadProjectFile = 'Upload project file';
export const Add = 'Add';
export const CreateNewProject = 'Create New Course';

export const Issues = 'Subject';
...
export const AddToCart = 'Subscribe';
...
export const Febric = 'Description';
export const Brand = 'Tutor';
