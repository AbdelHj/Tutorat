...
import Mycourses from '../Components/Application/Project/Mycourses';
...
import ListOfQuestions from '../Components/Application/Questions';
...
export const routes = [
  ...
  { path: `${process.env.PUBLIC_URL}/dashboard`, Component: <OnlineCourse /> },
  ...
  { path: `${process.env.PUBLIC_URL}/charts/chartist`, Component: <Chartist /> },
  ...
  { path: `${process.env.PUBLIC_URL}/forms/widget/timepicker`, Component: <Timepicker /> },
  ...
  // //Applicatiion
  { path: `${process.env.PUBLIC_URL}/app/project/project-list/:num`, Component: <Project /> },
  { path: `${process.env.PUBLIC_URL}/app/project/mycourses/`, Component: <Mycourses /> },
  ...
  { path: `${process.env.PUBLIC_URL}/courses/:num/activities`, Component: <TodoContain /> },
  ...
  { path: `${process.env.PUBLIC_URL}/completedCourses`, Component: <ProductListContain /> },
  { path: `${process.env.PUBLIC_URL}/inProgressCourses`, Component: <ProductListContain /> },
  { path: `${process.env.PUBLIC_URL}/app/kanban-board`, Component: <KanbanBoardContain /> },
  ...
  { path: `${process.env.PUBLIC_URL}/activity/:num`, Component: <ListOfQuestions /> },
];
