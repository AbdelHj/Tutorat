      ...
      <Slider className='m-0' {...notificationSliderOption}>
        <div className='d-flex h-100'>
          ...
          <H6 attrH6={{ className: 'mb-0 f-w-400' }}>
            <span className='font-primary'>JAVA </span>
            <span className='f-light'>A new course in java has been released.</span>
          </H6>
        ...
        <div className='d-flex h-100'>
          <Image attrImage={{ src: fireImage, alt: 'gif' }} />
          <H6 attrH6={{ className: 'mb-0 f-w-400' }}>
            <span className='f-light'>New courses are available! </span>
          </H6>
